...
namespace EducaGo.Web.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Correo")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Correo")] Profesor profesor)
        {
            if (id != profesor.Id)
            {
                return NotFound();
